        ...
        <div className="container-cv py-3 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-muted/60 text-xs font-semibold text-muted-foreground">
              ...
              <span>
                {profile?.role === 'client' ? 'Client Portal' : 'Member Portal'}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <nav className="hidden md:flex items-center gap-4 text-sm font-medium text-muted-foreground">
              ...
              <Link
                href="/dashboard"
                className={`flex items-center gap-1.5 transition-colors ${
                  isDashboardActive ? 'text-primary font-semibold' : 'hover:text-foreground'
                }`}
              >
              ...
              <Link
                href="/client/profile"
                className={`flex items-center gap-1.5 transition-colors ${
                  isProfileActive ? 'text-primary font-semibold' : 'hover:text-foreground'
                }`}
              >
            ...
            <ClientNotificationCenter userId={profile?.id} />
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Link
                ...
                className="flex items-center gap-2 p-1 pr-2 rounded-full hover:bg-muted/60 transition-colors border border-transparent hover:border-border"
              >
                <Avatar
              ...
              <button
                ...
                title="Sign Out"
                className="p-2 rounded-xl border border-border bg-card hover:bg-muted text-muted-foreground hover:text-[#9e3b32] transition-colors cursor-pointer"
              >
